...
<head>
    <meta charset="utf-8" />
    <title>Students Race Lessons</title>
...
<body>
    ...
    <div id="content" class="container-fluid row">
        ...
        <div id="box_body" class="container col-12 col-lg-8">
            <div id="body" class="animated zoomInDown" style="padding:0;overflow-x:hidden;overflow-y:scroll">
                ...
                <?php
                $comando2 = "SELECT ID, licao, imagem FROM licoes WHERE CODUnidade = $unidadeID";

                if($stmt = mysqli_prepare($link, $comando2)){
                    mysqli_stmt_execute($stmt);
                    mysqli_stmt_bind_result($stmt, $licaoID, $licao, $licaoIMG);
                    ...
                    while(mysqli_stmt_fetch($stmt)){
                        if( $i < $loop){
                             ...
                             echo "<td><div class=\"col-12 col-sm-4 unit hvr-grow\"><div class=\"card\"><div class=\"card-header\">$licao</div><div class=\"card-body\"><div id=\"img\" style=\"background-image: url(painel_admin/licoes/$licaoIMG)\"></div><a href=\"st_questions.php?lessonID=$licaoID&unitID=$unidadeID\" class=\"col-12 unit\">Start questions</a></div></div></div></td>";
