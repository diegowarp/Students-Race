...
?>
    ...
    <head>
        ...
        <script type="text/javascript">
			function validar(){
                var novasenha = formuser.novasenha.value;
				var rep_senha = formuser.confsenha.value;
                
				if (novasenha != rep_senha) {
       ...
       <?php   
                ...
                <ul class="dropdown-menu main">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu dropdown-item">
                            ...
                            <li>
                                <div tabindex="-1" href="admin_altera_senha.php" class="dropdown-item" style="padding-right: 0px; background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Alterar senha</div>
                            </li>
                        </ul>
                    </li>
        ...
        <navbar id="menu_large" class="container-fluid">
            ...
            <div class="dropdown large">
                ...
                <ul class="dropdown-menu main" id="drop-admin" style="left: 411px; top: 61px">
                    ...
                    <li>
                        <div class="dropdown-item hvr-grow" style="background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Alterar senha</div>
                    </li>
                </ul>
            </div>
            
            <!-- Nome dos ícones -->
            <div id="text_menu">Admin. - Alterar senha</div>
        ...
        <div id="content" class="container-fluid row">
            ...
            <div id="box_body" class="container col-12 col-lg-10 col-md-9">
                <form id="body" name="formuser" action="admin_back_altera_senha.php" method="POST" class="animated zoomInDown">
                    <div id="modal-header" class="container-fluid">
                        <p id="text-header">Altere sua senha</p>
                    </div>
                        ...
                        <center>
                            <div class="row col-12" style="padding: 0px">
                                ...
                                <div id="button-edit" class="container-fluid col-lg-6 col-12">
                                    <input id="btn-edit" type="submit" value="Alterar" name="adicionar" class="col-12 hvr-shrink" onclick="return validar()">
                                </div>
                            </div>
                        </center>
                    </div>
        ...
        <script src="js/admin_altera_senha.js"></script>
