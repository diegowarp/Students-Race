...
$palavra1  = $_GET['palavra'];
$idpalavra = $_GET['id'];
$_SESSION['idpalavra'] = $idpalavra;
}else{
    $palavra1 = "";
}
?>
    ...
    <body>
       <?php
                ...
                <ul class="dropdown-menu main">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu dropdown-item">
                            <li>
                                <div tabindex="-1" class="dropdown-item" style="padding-right: 0px; background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Adicionar palavra</div>
                            </li>
                            <li>
        ...
        <navbar id="menu_large" class="container-fluid">
            ...
            <div class="dropdown large">
                ...
                <ul class="dropdown-menu main" id="drop-dictionary" style="left: 203px; top: 61px">
                    <li>
                        <div class="dropdown-item hvr-grow" style="background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Adicionar palavra</div>
                    </li>
                    <li>
            ...
            <!-- Nome dos ícones -->
            <div id="text_menu">Dicionário - Adicionar palavra</div>
            ...
            <div id="box_body" class="container col-12 col-lg-10 col-md-9">
                <form id="body" action="admin_back_aceita_palavra.php" method="POST" enctype="multipart/form-data" class="animated zoomInDown">
                    <div id="modal-header" class="container-fluid">
                        ...
                        if($palavra1 != ""){
                        ?>
                            <p id="text-header">Adicione a palavra <span style="color: rgb(0,0,0); text-shadow: -1px 0 rgb(255,255,255), 0 1px rgb(255,255,255), 1px 0 rgb(255,255,255), 0 -1px rgb(255,255,255);"><?php echo $palavra1;?></span> ao dicionário</p>
                        <?php
                        }else{
                        ?>
                            <p id="text-header">Adicione palavras ao dicionário</p>
                        <?php
                        }
                        ?>
                    ...
                    <div id="modal-body" class="container-fluid">
                        ...
                        <div class="form-group" style="margin-bottom: 15px">
                            ...
                            <input class="form-control" id="plv" name="palavra" value="" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                            <label for="trd">Tradução</label>
                            <input class="form-control" id="trd" name="traducao" value="">
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                            <label for="cls">Classe</label>
                            <textarea class="form-control" id="cls" rows="2" name="classe" required></textarea>
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                            <label for="dfn">Definição</label>
                            <textarea class="form-control" id="dfn" rows="3" name="definicao" required></textarea>
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                            <label for="exm">Exemplo</label>
                            <textarea class="form-control" id="exm" rows="3" name="exemplo"></textarea>
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                        ...
                        <center>
                            <div class="row col-12" style="padding: 0px">
                                ...
                                <div id="button-edit" class="container-fluid col-lg-6 col-12">
                                    <input id="btn-edit" type="submit" value="Adicionar" name="adicionar" class="col-12 hvr-shrink">
                                </div>
                            </div>
                        </center>
                    </div>
        ...
        <script src="js/admin_aceita_palavra.js"></script>
