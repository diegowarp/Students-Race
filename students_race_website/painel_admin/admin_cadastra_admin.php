       ...
       <?php   
                ...
                <ul class="dropdown-menu main">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu dropdown-item">
                            ...
                            <li>
                                <div tabindex="-1" href="admin_cadastra_admin.php" class="dropdown-item" style="padding-right: 0px; background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Cadastrar<br>administrador</div>
                            </li>
                            <li>
        ...
        <navbar id="menu_large" class="container-fluid">
            ...
            <div class="dropdown large">
                ...
                <ul class="dropdown-menu main" id="drop-admin" style="left: 411px; top: 61px">
                    ...
                    <li>
                        <div tabindex="-1" href="admin_cadastra_admin.php" class="dropdown-item" style="background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Cadastrar<br>administrador</div>
                    </li>
                    <li>
                        <a tabindex="-1" href="admin_altera_senha.php" class="dropdown-item">Alterar senha</a>
                    </li>
            ...
            <!-- Nome dos ícones -->
            <div id="text_menu">Admin. - Cadastrar administrador</div>
        ...
        <div id="content" class="container-fluid row">
            ...
            <div id="box_body" class="container col-12 col-lg-10 col-md-9">
                <form id="body" name="formuser" action="admin_back_cadastra_admin.php" method="POST" class="animated zoomInDown">
                    <div id="modal-header" class="container-fluid">
                        <p id="text-header">Cadastrar administrador</p>
                    </div>
                    <div id="modal-body" class="container-fluid">
                        ...
                        <div class="form-group" style="margin-bottom: 15px">
                            ...
                            <input class="form-control" id="nome" name="nome" placeholder="Digite o nome do administrador" type="text" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                            <label for="usuario">Nome de usuário</label>
                            <input class="form-control" id="usuario" name="usuario" placeholder="Digite o nome de usuário" type="text" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                            <label for="email">Email</label>
                            <input class="form-control" id="email" name="email" placeholder="Digite o email" type="email" required>
                        </div>
                        <div class="form-group" style="margin-bottom: 15px">
                            <label for="senha">Senha</label>
                            <input class="form-control" id="senha" name="senha" style="margin-bottom: 5px" placeholder="Digite a senha" type="password" required>
                            <input class="form-control" id="csenha" name="csenha" aria-describedby="senhahelp" placeholder="Confirme a senha" type="password" required>
                            <small id="senhahelp" class="form-text">* A senha deve conter no mínimo 6 caracteres.</small>
                        </div>
                    </div>
        ...
        <script src="js/admin_cadastra_admin.js"></script>
    </body>
