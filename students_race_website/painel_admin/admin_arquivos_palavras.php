...
?>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Arquivos - Palavras sugeridas</title>
    ...
    <body>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu main">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu dropdown-item">
                            <li>
                                <div tabindex="-1" class="dropdown-item" style="padding-right: 0px; background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default" class="dropdown-item">Palavras sugeridas</div>
                            </li>
                        </ul>
                    </li>
        ...
        <navbar id="menu_large" class="container-fluid">
            ...
            <div class="dropdown large">
                ...
                <ul class="dropdown-menu main" id="drop-files" style="left: 359px; top: 61px">
                    <li>
                        <div class="dropdown-item hvr-grow" style="background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Palavras sugeridas</div>
                    </li>
                </ul>
            </div>
            ...
            <!-- Nome dos ícones -->
            <div id="text_menu">Arquivos - Palavras sugeridas</div>
        ...
        <div id="content" class="container-fluid row">
                ...
                <div id="box_body" class="container col-12 col-lg-10 col-md-9">
                    <div id="body" class="animated zoomInDown">
                        <div id="modal-header" class="container-fluid">
                            <p id="text-header">
                                Arquivos - Palavras sugeridas pelos usuários
                            </p>
                        </div>
                        <div id="modal-body" class="container-fluid">
                            <?php

                            $comando = "SELECT s.palavrasugerida, u.nomeuser, s.datahora, s.acao, a.nome FROM usuarios u INNER JOIN sugestoes s ON (u.ID = s.CODusuario) JOIN administradores a ON (a.ID = s.admin) WHERE s.visto = 1";
                          
                            if($stmt = mysqli_prepare($link, $comando)){
                                mysqli_stmt_execute($stmt);
                                mysqli_stmt_bind_result($stmt, $palavra, $nomeuser, $datahora, $acao, $nome_admin );

                                echo "<div class=\"table-responsive\">";
                                echo "<table class=\"table table-bordered\">";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th scope=\"col\" style=\"padding-right: 95px; padding-left: 95px; border-left: 0px\">
                                                    Palavra
                                             </th>";            
                                        echo "<th scope=\"col\">
                                                    Data e hora
                                              </th>";
                                        echo "<th scope=\"col\" style=\"padding-right: 85px; padding-left: 85px\">
                                                    Usuário
                                              </th>";
                                        echo "<th scope=\"col\" style=\"padding-right: 90px; padding-left: 90px\">
                                                    Ação
                                              </th>";
                                        echo "<th scope=\"col\" style=\"padding-right: 40px; padding-left: 40px\">
                                                    Administrador
                                              </th>";
                                    echo "</tr>";
                                echo "</thead>";
                                ...
                                while (mysqli_stmt_fetch($stmt)) {
                                    ...
                                    echo "<tr>";
                                        echo "<td style=\"border-left: 0px\">".$palavra."</td>";
                                        echo "<td>".date('d/m/Y H:i:s', $novadata)."</td>";
                                        echo "<td>".$nomeuser."</td>";
                                        echo "<td>".$acao."</td>";
            ...
            <script src="js/admin_arquivos_palavras.js"></script>
    </body>
