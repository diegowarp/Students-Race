...
?>
    ...
    <!-- Small Menu -->
                ...
                <ul class="dropdown-menu main">
                    ...
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu dropdown-item">
                            ...
                            <li>
                                <div tabindex="-1" style="padding-right: 0px; background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default" class="dropdown-item">Adicionar lição</div>
                            </li>
                            <li>
        ...
        <navbar id="menu_large" class="container-fluid">
            ...
            <div class="dropdown large">
                ...
                <ul class="dropdown-menu main" id="drop-content" style="left: 307px; top: 61px">
                    ...
                    <li>
                        <div class="dropdown-item hvr-grow" style="background: rgba(255,255,255,0.75); color: rgb(0,0,0); cursor: default">Adicionar lição</div>
                    </li>
                    <li>
            ...
            <!-- Nome dos ícones -->
            <div id="text_menu">Conteúdo - Adicionar lição</div>
        ...
        <div id="content" class="container-fluid row">
            ...
            <div id="box_body" class="container col-12 col-lg-10 col-md-9">
                <form id="body" name="formuser" action="admin_back_cadastra_licao.php" method="POST" enctype="multipart/form-data" class="animated zoomInDown">
                ...
                <div id="modal-body" class="container-fluid">
                    ...
                    <div class="form-group" style="margin-bottom: 15px">
                        ...
                        <select class="form-control" id="sel1" name="unidade" onchange="carregar(this.id, 'sel2')" required>
                            <option value=""></option>
                            <?php
                    ...
                    <div class="form-group" style="margin-bottom: 15px">
                        ...
                        <input class="form-control" id="licao" name="licao" style="margin-bottom: 5px" placeholder="Digite o nome da lição" required>
                    </div>

                    <div class="row justify-content-center">
                        <div id="image" class="form-group col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                            <label for="image">Imagem da lição</label>
                            <input id="image" name="imagem" type="file" class="inputfile" onchange="preview();" required>
                            <img id="image" name="img_preview" src="css/img/lesson.png">
                        </div>
                    </div>
                </div>
    ...
    <script src="js/admin_cadastra_licao.js"></script>
